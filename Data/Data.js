const data = {
  name: 'Alberto Del Pino Chinchilla',
  address: 'Avenida Paises Catalanes, Tarragona, Cataluña',
  email: 'albertochinchilla1999@gmail.com',
  avatar:
  ...
  aboutMe:
    'Soy una persona trabajadora y apasionada por el aprendizaje continuo. Me motiva enfrentar y superar desafíos, lo que me ha llevado a explorar un nuevo sector profesional con entusiasmo y dedicación.',

  education: {
    degree: 'Grado superior en sistemas electrónicos y autimatización',
    university: 'Politécnico Jesús Marín',
    graduationYear: 2020,

    relevantCourses: ['Full stack Developer', 'Knx Partner y Avanzado']
  },
  workExperience: [
    {
      ...
      endDate: '2022',
      description:
        'Profesional cualificado en instalaciones electricas de baja tensión en industria, montaje de infraestructura y cuadrista'
    },
    {
      position: 'Técnico en domótica ',
      company: 'Editecnia',
      startDate: '2022',
      endDate: '2023',
      description:
        'Instalador, mantenimiento y programador. Trato con clientes en inglés.'
    }
  ],
  skills: [
    'HTML5',
